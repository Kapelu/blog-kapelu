...
{/*<Blockquote author='Kent Beck'>
          <p>
            La programación no consiste únicamente en escribir código. También
            implica aprender constantemente, mejorar los procesos, refactorizar
            y desarrollar hábitos que permitan mantener un ritmo de trabajo
            sostenible a largo plazo.
          </p>

          <p>
            Los buenos hábitos terminan siendo más importantes que los momentos
            de brillantez aislados.
          </p>

          <p>
            Por eso la disciplina, la práctica deliberada y la capacidad de
            aprender de los errores son habilidades tan valiosas en un
            desarrollador.
          </p>
        </Blockquote>*/}