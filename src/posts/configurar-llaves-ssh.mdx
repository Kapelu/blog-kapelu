...
![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh01.png)

Después nos pide una contraseña con espacios (es recomendable ponerla)

![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh02.png)

Volvemos a ingresar la contraseña:

![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh03.png)

Nos genera la llave privada: id_rsa en una carpeta oculta .ssh dentro del directorio home y la llave pública id_rsa.pub

![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh04.png)

Una vez obtenido el resultado sabremos que hemos creado nuestras llaves (pública y privada) SSH satisfactoriamente:

![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh05.png)
...
![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh06.png)
...
![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh07.png)
...
![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh08.png)
...
![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh08-2.png)

## Agregando las llaves a github

Debemos de ir a nuestro GitHub → settings → SSH and GPG Keys → New SSH Key

![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh09.png)
...
![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh10.png)

Damos click a Add SSH Key, podemos ver que nos agregó una nueva llave con el nombre que le dimos, pero aún no se ha usado.

![configurar clave SSH](/public/images/images-posts/configurar-claves-ssh/configurar-claves-ssh11.png)
