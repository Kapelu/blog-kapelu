---
title: "Creación de script en bash"
description: "Pasos para la creación de un script en bash"
date: "2024-12-30"
author: "Kapelu"
tags:
  - linux
  - Bash
cover: "/images/images-posts/script-en-bash.webp"
---
...
* Crear el archivo con extension .sh
  ...
  ```
  ![crear-script-bash](/images/images-posts/crear-script-bash/crear-script-bash01.png)
...
* Añadir permisos chmod desde la terminal 
  ...
  chmod 711 hello.sh
  ```
  ![crear-script-bash](/images/images-posts/crear-script-bash/crear-script-bash02.png)
...
* Si quieres ejecutar tu script bash desde cualquier lugar, como si fuera un comando normal primero debes saber la ruta donde esta creado el script, esto lo haces con el comando `pwd`
  ...
  pwd
  ```
  ![crear-script-bash](/images/images-posts/crear-script-bash/crear-script-bash03.png)
  ...
  ```
  ![crear-script-bash](/images/images-posts/crear-script-bash/crear-script-bash04.png)
